  ...
  <nav class="navbar fixed-top">
    ...
    <div class="navbar-right">
      ...
      <div class="user d-inline-block">
        ...
        <b-dropdown id="ddown1" :text="$t(currentUser.title)" variant="outline-secondary">
                <b-dropdown-header>{{ $t(currentUser.title) }}</b-dropdown-header>
                <b-dropdown-divider />
                <b-dropdown-item @click="profileSetting">Profile Setting</b-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    profileSetting(){
    this.$router.push("/app/applications/profile-setting");
    },
